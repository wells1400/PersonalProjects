...
def build_lstm_model(inputDim = 10,lr=0.001,nb_hidden_cell=[80]):
    ...
    model.add(LSTM(nb_hidden_cell[0],input_shape=(1,inputDim),use_bias=True,activation='relu',name='layer_0',
...
#     early_stopping = EarlyStopping(monitor='val_loss', patience=50)
    checkpointer = ModelCheckpoint(filepath="/home/wells/Wells/\checkpoint.hdf5",
